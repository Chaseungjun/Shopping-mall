...
public class QItemImg extends EntityPathBase<ItemImg> {
    ...
    private static final long serialVersionUID = -644685300L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QItemImg itemImg = new QItemImg("itemImg");

    public final com.example.shop2.domain.QBaseEntity _super = new com.example.shop2.domain.QBaseEntity(this);
